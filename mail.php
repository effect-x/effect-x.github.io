<meta http-equiv='refresh' content='3; url=https://effect-x.github.io/'>
<meta charset="UTF-8" />
<?php
	...
	$address = "alexune@bk.ru";//адрес куда будет отсылаться сообщение для администратора
	...
	if ($send) //проверяем, отправилось ли сообщение
		echo "Сообщение отправлено успешно! Перейти на <a href='https://effect-x.github.io/'>Эффект</a>, если вас не перенаправило вручную.";
	else 
